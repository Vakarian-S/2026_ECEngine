...
TransformComponent::TransformComponent(std::shared_ptr<Component> parent_): Component(parent_)
{
...
TransformComponent::TransformComponent(std::shared_ptr<Component> parent_, Vec3 pos_, Quaternion orientation_, Vec3 scale_)
