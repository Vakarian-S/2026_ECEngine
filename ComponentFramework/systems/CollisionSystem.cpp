                                                    ...
                                                    Ref<PhysicsComponent> pc2)
{
    ...
    const MATH::Vec3 v1 = pc1->velocity;
    const MATH::Vec3 v2 = pc2->velocity;
    const float m1 = pc1->mass;
    const float m2 = pc2->mass;
    ...
    pc1->velocity = v1 + (v1p_new - v1P) * n;
    pc2->velocity = v2 + (v2p_new - v2P) * n;
}
