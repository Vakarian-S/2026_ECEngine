...
public:
    TransformComponent(std::shared_ptr<Component> parent_);
    TransformComponent(std::shared_ptr<Component> parent_, Vec3 pos_, Quaternion orientation_, Vec3 scale_ = Vec3(1.0f, 1.0f, 1.0f));
    ~TransformComponent();
