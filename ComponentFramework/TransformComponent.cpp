...
TransformComponent::TransformComponent(WeakRef<Component> parent_): Component(parent_)
{
...
TransformComponent::TransformComponent(WeakRef<Component> parent_, Vec3 pos_, Quaternion orientation_, Vec3 scale_)
